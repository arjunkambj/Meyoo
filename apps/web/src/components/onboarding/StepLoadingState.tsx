...
const StepLoadingState = React.memo(function StepLoadingState({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[40vh] sm:min-h-[50vh] md:min-h-[60vh] gap-4 bg-gradient-to-b from-transparent to-surface-secondary/20 px-4">
      ...
      <p className="text-muted text-sm sm:text-base md:text-lg text-center">
        {message}
      </p>
    </div>
  );
